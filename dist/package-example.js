...
function pe() {
  ...
  return y.Fragment = p, y.jsx = x, y.jsxs = x, y;
}
var j = {};
/**
 * @license React
...
` + l[a].replace(
    ...
    function G(e, r, t, n, u, a) {
      if (typeof e == "string" || typeof e == "function" || e === P || e === F || e === X || e === M || e === $ || e === xe || typeof e == "object" && e !== null && (e.$$typeof === U || e.$$typeof === W || e.$$typeof === Z || e.$$typeof === L || e.$$typeof === Y || e.$$typeof === we || e.getModuleId !== void 0)) {
        var o = r.children;
        if (o !== void 0)
          if (n)
            if (q(o)) {
...
var ke = he();
const Se = ({ label: s }) => /* @__PURE__ */ ke.jsx("button", { children: s });
export {
  Se as Button
};
